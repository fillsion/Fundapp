...
exports.updateUser = exports.saveUser = exports.getUserCount = exports.getUser = exports.getSingleUser = exports.deleteUser = void 0;
...
var getUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var sql, connection, _yield$connection$que, _yield$connection$que2, rows;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            _context2.next = 6;
            return connection.query(sql, [req.params.cedula]);
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            sql = "INSERT INTO user(cedula, name, apellidos, celular, correo, codigoPostal, ciudad) VALUES (?,?,?,?,?,?,?)";
            _context4.next = 3;
            return (0, _database.connect)();
          ...
          case 3:
            ...
            _context4.next = 6;
            return connection.query(sql, [req.body.cedula, req.body.name, req.body.apellidos, req.body.celular, req.body.correo, req.body.codigoPostal, req.body.ciudad]);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            sql = "DELETE FROM user WHERE cedula = ?";
            _context5.next = 6;
            return connection.query(sql, [req.params.cedula]);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            sql = "UPDATE user SET ? WHERE cedula = ?";
            _context6.next = 6;
            return connection.query(sql, [req.body, req.params.cedula]);
